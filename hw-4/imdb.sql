...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Jan 15, 2021 at 10:21 AM
...
--
-- Table structure for table `film_kuca`
--

DROP TABLE IF EXISTS `film_kuca`;
CREATE TABLE IF NOT EXISTS `film_kuca` (
  `id_film` int(11) NOT NULL,
  `id_kuce` int(11) NOT NULL,
  PRIMARY KEY (`id_film`,`id_kuce`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- --------------------------------------------------------

--
-- Table structure for table `film_reziser`
--

DROP TABLE IF EXISTS `film_reziser`;
CREATE TABLE IF NOT EXISTS `film_reziser` (
  `id_film` int(11) NOT NULL,
  `id_reziser` int(11) NOT NULL,
  PRIMARY KEY (`id_film`,`id_reziser`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- --------------------------------------------------------

--
-- Table structure for table `film_scenarista`
--

DROP TABLE IF EXISTS `film_scenarista`;
CREATE TABLE IF NOT EXISTS `film_scenarista` (
  `id_film` int(11) NOT NULL,
  `id_scenarista` int(11) NOT NULL,
  PRIMARY KEY (`id_film`,`id_scenarista`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
DROP TABLE IF EXISTS `kuca`;
CREATE TABLE IF NOT EXISTS `kuca` (
...
CREATE TABLE IF NOT EXISTS `reziser` (
  `id_reziser` int(11) NOT NULL AUTO_INCREMENT,
  `ime` int(50) NOT NULL,
  `prezime` int(50) NOT NULL,
...
--
-- Table structure for table `scenatista`
--

DROP TABLE IF EXISTS `scenatista`;
CREATE TABLE IF NOT EXISTS `scenatista` (
  `id_scenarista` int(11) NOT NULL AUTO_INCREMENT,
  `ime` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `prezime` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id_scenarista`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
